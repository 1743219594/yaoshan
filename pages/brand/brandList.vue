	...
	<view>
		...
		<view class="info">
			<view class="image-wrapper">
				...
				<image src="https://img2.baidu.com/it/u=628821898,3957836052&fm=253&fmt=auto&app=138&f=JPEG?w=500&h=500"
					class="loaded" mode="aspectFit"></image>
			</view>
			<view class="title">
		...
		<!-- 品牌故事 -->
		<view class="section-tit">商家简介</view>
...
<script>
	...
	export default {
		...
		onLoad(options) {
			...
			this.$api.request.getBrandDetail(method, {}, response => {
		...
		methods: {
			...
			async loadData(type = 'add', loading) {
				...
				this.$api.request.fetchBrandProductList(this.queryParam, response => {
