	...
	<!-- 	<view class="yt-list">
		...
		<view class="yt-list">
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">￥{{calcAmount.payAmount - calcAmount.freightAmount}}</text>
			</view>
			<view class="yt-list-cell b-b">
...
<script>
	...
	export default {
		...
		methods: {
			//生成确认单信息
			async loadData() {
				this.$api.request.generateConfirmOrder(JSON.stringify(this.cartIds), response => {
			...
			submit() {
				...
				this.$api.request.createOrder(orderParam,res=>{
